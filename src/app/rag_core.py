...
SUBJECT_KEYWORDS: Dict[str, List[str]] = {
    "CAP023": ["kickstarter", "crowdfunding", "campaign", "rewards", "funding goal", "pre-launch", "kenneth li"],
    "CAP024": ["design thinking", "prototype", "prototyping", "product development", "user feedback", "donn koh"],
    "CAP025": ["fundraising video", "campaign video", "script", "storytelling", "video production", "emotional hook"],
    "CAP301": ["capstone", "project management", "milestone", "scope", "time management", "documentation"],
    "COMM203": ["public speaking", "stage presence", "speech", "presentation", "voice", "lizzie docel"],
    "STC101": ["copywriting", "headline", "direct response", "call to action", "cta", "sales copy", "melanie lee"],
    "CRBL101": ["web3", "blockchain", "nft", "dao", "decentralized", "crypto", "nitin gaur"],
    "FIFI103": ["metrics", "kpi", "financial modeling", "operational efficiency", "data analysis", "profitability", "ankur kuishrestha"],
    "FIFI104": ["venture capital", "vc", "fundraising", "seed round", "series a", "valuation", "pitch deck", "josh lim"],
    "LEIP101": ["intellectual property", "ip", "patent", "trademark", "copyright", "nda", "legal", "boon tat"],
    "PRTC204": ["python", "machine learning", "ml", "ai", "algorithm", "coding", "data pipeline", "mahesh paik"],
    "MAST204": ["competitive strategy", "porter", "five forces", "blue ocean", "game theory", "vipin sreekumar"],
    "MAST205": ["corporate innovation", "immersion", "nus", "cross-cultural", "innovation strategy"],
    "LA103": ["southeast asia", "singapore", "public policy", "governance", "regional development"],
    "MAST103": ["macroeconomics", "international finance", "interest rate", "trade balance", "geopolitics", "garima chaklader"],
    "SAMA103": ["market research", "consumer psychology", "survey", "interview", "qualitative", "quantitative", "bhupesh manoharan"]
}
